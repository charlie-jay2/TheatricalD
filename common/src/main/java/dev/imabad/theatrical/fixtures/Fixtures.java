...
public class Fixtures {
	...
	public static final RegistrySupplier<Fixture> MOVING_LIGHT =
		...
		public static final RegistrySupplier<Fixture> MOVING_LIGHT_R3X =
		FIXTURES.register(new ResourceLocation(Theatrical.MOD_ID, "moving_light_r3x"), MovingLightFixture::new);
